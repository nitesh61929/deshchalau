export const T = {
  en: {
    ...
    landing: {
      ...
      step1: "You are the Prime Minister of Nepal.",
      step2: "Face 5 real-inspired crises across 5 years.",
      step3: "Make decisions that affect 5 national meters.",
      step4: "Survive — and see your legacy.",
    },
    gameOver: {
      title: "Game Over",
  ...
  np: {
    site: {
      tagline: "नेपाल चलाउन सक्नुहुन्छ?",
    },
    nav: {
      mute: "म्युट",
      unmute: "अनम्युट",
    ...
    game: {
      year: "वर्ष",
      chooseAction: "आफ्नो निर्णय छान्नुहोस्:",
    ...
    landing: {
      ...
      step1: "तपाईं नेपालका प्रधानमन्त्री हुनुहुन्छ।",
      step2: "५ वर्षमा ५ वास्तविक संकटहरू सामना गर्नुहोस्।",
      step3: "५ राष्ट्रिय सूचकहरूलाई असर गर्ने निर्णयहरू गर्नुहोस्।",
      step4: "बाँच्नुहोस् — र आफ्नो विरासत हेर्नुहोस्।",
    },
    gameOver: {
      title: "खेल सकियो",
